...
namespace EntityFrameWork.Models
{
    public partial class AdventureWorks2016Context : DbContext
    {
        ...
        public virtual DbSet<EmployeeHireDate> EmployeeHireDates { get; set; }
        ...
        public virtual DbSet<Productss> Productsses { get; set; }
        ...
        public virtual DbSet<StudentDetail1> StudentDetails1 { get; set; }
        ...
        public virtual DbSet<VSalesByCategorY> VSalesByCategories { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=PC0626\\MSSQL2019;Database=AdventureWorks2016;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Deposite>(entity =>
            {
                ...
                entity.HasOne(d => d.BnameNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.Bname)
                    .HasConstraintName("FK_dBNAME");

                entity.HasOne(d => d.CnameNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.Cname)
                    .HasConstraintName("FK_dCNAME");
            });
            ...
            modelBuilder.Entity<EmployeeHireDate>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("EmployeeHireDate", "HumanResources");
            ...
            modelBuilder.Entity<MyEmployee>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.FirstName, e.LastName }, "NonClusteredIndex-20220627-114133");
                ...
                entity.HasOne(d => d.Manager)
                    ...
                    .HasConstraintName("FK_MyEmployees_ManagerID_EmployeeID");
            });
            ...
            modelBuilder.Entity<Product2>(entity =>
            {
                ...
                entity.HasOne(d => d.SizeUnitMeasureCodeNavigation)
                    .WithMany(p => p.Product2SizeUnitMeasureCodeNavigations)
                    .HasForeignKey(d => d.SizeUnitMeasureCode);

                entity.HasOne(d => d.WeightUnitMeasureCodeNavigation)
                    .WithMany(p => p.Product2WeightUnitMeasureCodeNavigations)
            ...
            modelBuilder.Entity<StudentDetail>(entity =>
            {
                ...
                entity.Property(e => e.MonthlyPresent).HasColumnName("Monthly_Present");

                entity.Property(e => e.Name)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.SexStandard)
                    .HasMaxLength(5)
                    .IsUnicode(false);
            });

            modelBuilder.Entity<StudentDetail1>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<TestTran>(entity =>
            {
                entity.HasKey(e => e.Cola)
                    .HasName("PK__TestTran__A259EE645CD12679");
            ...
            modelBuilder.Entity<VSalesByCategorY>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vSalesByCategorY", "Sales");
